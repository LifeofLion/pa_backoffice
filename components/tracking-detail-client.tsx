...
const TrackingMap = dynamic(
	() => import('@/src/components/tracking/tracking-map'),
	{
		ssr: false,
		loading: () => (
				...
				<main className='container mx-auto px-4 py-8'>
					<div className='max-w-3xl mx-auto text-center'>
						<h1 className='text-2xl font-semibold mb-4'>
							{t('tracking.packageNotFound')}
						</h1>
						<p className='text-gray-600 mb-6'>
							{t('tracking.invalidTrackingId')}
						</p>
						<Link
				...
				<div className='max-w-3xl mx-auto'>
					...
					<div className='bg-white rounded-lg shadow-md p-6 mb-6'>
						<div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6'>
							...
							<div
								className={`mt-2 sm:mt-0 px-3 py-1 rounded-full ${statusInfo.color} flex items-center`}
							>
								{statusInfo.icon}
								...
								{livePosition && (
									<div className='mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200'>
										...
										<div className='text-xs text-gray-600'>
											<div>
												Lat:{' '}
												{livePosition.latitude.toFixed(
													6
												)}
											</div>
											<div>
												Lng:{' '}
												{livePosition.longitude.toFixed(
													6
												)}
											</div>
											{livePosition.speed && (
							...
							<button
								onClick={() =>
									...
									reportIssue({
										type: 'other',
										description:
											"Problème signalé depuis l'interface",
									})
								}
