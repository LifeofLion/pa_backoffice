...
export default function Login() {
	...
	useEffect(() => {
		if (isAuthenticated && user) {
			...
			if (role === 'admin') {
				...
				setError("L'utilisateur actuel n'est pas un administrateur.");
			}
		}
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		const frontendErrors =
			FrontendValidators.validateLoginRequest(formData);
		...
		<div className='min-h-screen flex items-center justify-center bg-green-50 p-4'>
			...
			<div className='bg-white rounded-3xl p-6 sm:p-8 w-full max-w-md mx-auto'>
				...
				<p className='text-gray-600 text-center mb-6'>
					{t('auth.pleaseEnterEmailPassword')}
				</p>
					...
					<div>
						<div className='flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2'>
							...
							<Link
								...
								className='text-gray-500 text-sm hover:text-green-500 mt-1 sm:mt-0'
							>
