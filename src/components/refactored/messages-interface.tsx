...
export const createClientFilterConfig = (): FilterConfig => ({
  showAll: true,
  filters: [
    { key: "delivery", label: "Livraison", type: "delivery" },
    { key: "service", label: "Services", type: "service" }
  ]
})

export const createDeliverymanFilterConfig = (): FilterConfig => ({
  showAll: true,
  filters: [
    { key: "client", label: "Clients", type: "client" },
    { key: "shopkeeper", label: "Commerçants", type: "shopkeeper" }
  ]
})

export const createServiceProviderFilterConfig = (): FilterConfig => ({
  showAll: false,
  filters: [
    { key: "client", label: "Clients", type: "client" }
  ]
...
export const createShopkeeperFilterConfig = (): FilterConfig => ({
  showAll: true,
  filters: [
    { key: "delivery", label: "Livreurs", type: "delivery" },
    { key: "client", label: "Clients", type: "client" }
  ]
}) 