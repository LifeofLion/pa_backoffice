...
export class AdminUtils {
	...
	static transformService(service: any): AdminServiceData {
		return {
			...
			prestataireName:
				service.prestataireName || service.prestataire_name || 'N/A',
			prestataireEmail:
				service.prestataireEmail || service.prestataire_email || 'N/A',
			prestataireRating:
				service.prestataireRating || service.prestataire_rating,
			serviceType: service.serviceType || 'Non défini',
			serviceTypeId: service.service_type_id || service.serviceTypeId,
			location: service.location,
			status: service.status || 'available',
			availability_description: service.availability_description || null,
			home_service:
				service.home_service !== undefined
					? service.home_service
					: true,
			requires_materials:
				service.requires_materials !== undefined
